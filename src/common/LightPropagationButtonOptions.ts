/**
 * LightPropagationButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = LightPropagationColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link LightPropagationColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: LightPropagationColors.controlSurfaceColorProperty,
  listFill: LightPropagationColors.controlSurfaceColorProperty,
  buttonStroke: LightPropagationColors.panelBorderColorProperty,
  listStroke: LightPropagationColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: LightPropagationColors.textColorProperty },
  },
