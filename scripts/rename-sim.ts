...
const REPLACEMENTS: ReadonlyArray<[string, string]> = [
  ...
  ["LightPropagationScreenSummaryContent", `${newPrefix}ScreenSummaryContent`],
  ["LightPropagationKeyboardHelpContent", `${newPrefix}KeyboardHelpContent`],
  ["LightPropagationPreferencesModel", `${newPrefix}PreferencesModel`],
  ["LightPropagationPreferencesNode", `${newPrefix}PreferencesNode`],
  ["LightPropagationScreenView", `${newPrefix}ScreenView`],
  ["LightPropagationColors", `${newPrefix}Colors`],
  ["LightPropagationNamespace", `${newPrefix}Namespace`],
  ["LightPropagationScreen", `${newPrefix}Screen`],
  ["LightPropagationModel", `${newPrefix}Model`],
  // camelCase identifier
  ["lightPropagationQueryParameters", `${newCamel}QueryParameters`],
  // Display strings
  ["Light Propagation", newName],
  // Kebab identifiers (path segments and package name)
  ["light-propagation", newId],
  ["light-propagation-screen", `${newId}-screen`],
];
...
console.log(`  id:     light-propagation → ${newId}`);
console.log(`  name:   Light Propagation → ${newName}`);
